...
@Component({
  ...
  standalone: true,
  imports: [ConversationListComponent, MessageComposerComponent, MessageTimelineComponent, ThreadPreviewComponent],
...
export class ChannelMessagingPageComponent {
  ...
  readonly composerDisabledReason = computed(() => {
    ...
    if (!page.conversation.viewerIsParticipant || !page.conversation.capabilities.includes('readBody')) {
